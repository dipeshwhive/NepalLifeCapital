        ...
        <div class="row gx-0 align-items-center">
            <div class="col-lg-7 px-5 text-start font">
                <div class="h-100 d-inline-flex align-items-center">
                    ...
                    <small class="me-3">{{ siteSetting()->phone_number }}</small>
                </div>
                <div class="h-100 d-inline-flex align-items-center">
            ...
            <div class="col-lg-5 px-5 text-end">
                <div class="h-100 d-inline-flex align-items-center small">
                    @foreach (socialSites() as $site)
                        <a title="Social Site" class href="{{ $site->featured_link }}" target="_blank"><img
                                title="Social Site" src="{{ getImage('site', $site->featured_image) }}"
    ...
    <div class="container col-10 border-bottom">
        <div class="row ">
            <div class="col-md-7 col-12">
                <a title="{{ siteSetting()->site_name }}" href="{{ route('home') }}"
                    class="navbar-brand d-flex justify-content-md-start justify-content-center">
                    <img title="{{ siteSetting()->site_name }}" class="img-fluid img"
                        src="{{ getImage('site', siteSetting()->site_logo) }}" alt="{{ siteSetting()->site_name }}"
                        width="30%" />
                </a>
            </div>
                                                            ...
                                                            @foreach (primaryService() as $primary)
                                                                <div class="mb-2">
                                                                    <a title="Primary Service"
                                                                        ...
                                                                        href="{{ route('primaryService', $primary->slug) }}">{{ $primary->title }}<span
